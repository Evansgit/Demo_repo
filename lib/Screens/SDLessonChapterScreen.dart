...
import 'package:smart_deck/SDUtils/Lipsum.dart' as lipsum;
          ...
          actions: <Widget>[
            Container(
              ...
              child: Row(
                ...
                children: <Widget>[Icon(Icons.details, color: Colors.black), SizedBox(width: 15), Icon(Icons.message, color: Colors.black), SizedBox(width: 15), Icon(Icons.more_vert, color: Colors.black)],
              ),
            ),
          ],
        ),
