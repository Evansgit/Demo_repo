...
import 'package:smart_deck/ModelClass/SDSearchModel.dart';
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: mFilterList[index].isSelected ? Icon(Icons.radio_button_checked, color: sdPrimaryColor, size: 22) : Icon(Icons.radio_button_unchecked, color: sdPrimaryColor, size: 22),
                              ),
                            ],
                          ),
                        ),
